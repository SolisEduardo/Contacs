...
interface UserDao {
    ...
    @Query("UPDATE user_table SET firstName = :firstName, lastName = :lastName, email = :email, job = :job WHERE id =:id")
    suspend fun updateUser(id:Int,firstName: String?, lastName: String?, email:String?, job: String?)
